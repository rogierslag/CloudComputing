...
public class SchedulerUnitTest {
	...
	public void test_bucketFiles() {
		...
		try {
			...
			String inputBucket = getPrivateField(scheduler, Properties.class, "properties").getProperty("aws.s3" +
					".input");
			long pollDelay = Long.parseLong(getPrivateField(scheduler, Properties.class, "properties").getProperty(
					"scheduler.check_every_x_seconds"))*1000;
	 ...
	 * @param object The class to get the field from
	 * @param klass The class of the field (no primitives)
	 * @param fieldString The name of the field in the class
	 * @param <T>
